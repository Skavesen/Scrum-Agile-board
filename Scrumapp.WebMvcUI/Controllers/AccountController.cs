            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!_roleManager.Roles.Any())
                    {
                        ...
                        await _projectService.AddTaskStatus(new ProjectTaskStatus { Id = "1", Name = "Задачи" });
                        await _projectService.AddTaskStatus(new ProjectTaskStatus { Id = "2", Name = "В работе" });
                        await _projectService.AddTaskStatus(new ProjectTaskStatus { Id = "3", Name = "Тестирование" });
                        await _projectService.AddTaskStatus(new ProjectTaskStatus { Id = "4", Name = "Выполненные" });
